...
data = dict(
    ...
    workers_per_gpu=1,
     train=dict(
        ann_file='/mnt/d/Github/mmdetection/project/LogMiniDet/data/train/annotations/instances_train2017.json',
        img_prefix='/mnt/d/Github/mmdetection/project/LogMiniDet/data/train/images/',
...
load_from = 'project/LogMiniDet/work_dir/autoassign/r50/nasfpn_dcn_mstrain/latest.pth'
