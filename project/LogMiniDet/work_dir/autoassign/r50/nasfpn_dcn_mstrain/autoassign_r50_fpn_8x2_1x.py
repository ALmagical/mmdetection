...
data = dict(
    ...
    train=dict(
        type='LogMiniDet',
        ann_file=
        '/mnt/d/Github/mmdetection/project/LogMiniDet/data/train/annotations/instances_train2017.json',
        img_prefix=
        '/mnt/d/Github/mmdetection/project/LogMiniDet/data/train/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
